...
object PatternFinder {
    ...
    fun clusterizeData(beats: List<Pair<Int, Int>>): IntArray {
        ...
        val kmeans = KMeans.fit(deltaBeats2D, 4, 1000, 0.0001)
    ...
    fun findPatterns(data: IntArray): Map<Int, MutableSet<Pair<IntArray, IntArray>>> {
        ...
        patternsByLength[3]?.add(Pair(IntArray(3) { -1 }, IntArray(0)))
        patternsByLength[4]?.add(Pair(IntArray(4) { -1 }, IntArray(0)))
        patternsByLength[5]?.add(Pair(IntArray(5) { -1 }, IntArray(0)))
